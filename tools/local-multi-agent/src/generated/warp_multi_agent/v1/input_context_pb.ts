...
// @generated from file input_context.proto (package warp.multi_agent.v1, syntax proto3)
/* eslint-disable */
...
import type { FileContent } from "./file_content_pb.js";
import { file_file_content } from "./file_content_pb.js";
import type { ExecutedShellCommand } from "./attachment_pb.js";
import { file_attachment } from "./attachment_pb.js";
import { file_options } from "./options_pb.js";
import type { SkillDescriptor } from "./skill_pb.js";
import { file_skill } from "./skill_pb.js";
import type { LspDescriptor } from "./lsp_pb.js";
import { file_lsp } from "./lsp_pb.js";
...
export const file_input_context: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_timestamp, file_file_content, file_attachment, file_options, file_skill, file_lsp]);
...
export type InputContext = Message<"warp.multi_agent.v1.InputContext"> & {
   ...
   */
  git?: InputContext_Git | undefined;
   ...
   */
  updatedSkillsContext?: InputContext_SkillsContext | undefined;
   ...
   */
  updatedLspServersContext?: InputContext_LspServersContext | undefined;
