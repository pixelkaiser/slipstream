...
pub fn get_cloud_mode_tips() -> Vec<CloudModeTip> {
    vec![
        ...
        CloudModeTip::new(
            "Fork a completed Oz cloud agent session into the desktop app to continue the work locally.",
            Some("https://docs.warp.dev/agent-platform/cloud-agents/viewing-cloud-agent-runs"),
        ),
        CloudModeTip::new(
        ...
        CloudModeTip::new(
            "Use `oz agent run` to kick off tasks without opening the terminal.",
            Some("https://docs.warp.dev/agent-platform/cloud-agents/platform"),
        ),
        CloudModeTip::new(
