...
const TITLE_TEXT: &str = "Sharing in Drive";
const BODY_TEXT: &[&str] = &[
    "You can now share drive objects in the app or on the web with anyone. Click Share in the Drive menu or the pane header to share via link or email.",
