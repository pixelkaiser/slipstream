...
const DELETE_TEAM_BODY_TEXT: &str = "Deleting this team will permanently delete it and all of its related content, including billing information or request balance. You will not be able to restore them.";
const LEAVE_TEAM_BODY_TEXT: &str = "You will need to be reinvited in order to rejoin.";
const LEAVE_TEAM_RELOAD_CREDITS_BODY_TEXT: &str = "If you leave this team, you’ll lose access to any remaining request balance tied to it. You’ll regain access to any unused, non-expired balance if you rejoin the same team later.";
const REMOVE_TEAM_MEMBER_RELOAD_CREDITS_BODY_TEXT: &str = "This member will lose access to any remaining request balance tied to this team. If they rejoin later, they’ll regain access to any unused, non-expired balance.";
