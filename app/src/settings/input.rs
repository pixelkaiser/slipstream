...
define_settings_group!(InputSettings,
    settings: [
        ...
        local_ai_autocomplete: LocalAIAutocomplete {
            type: bool,
            default: false,
            supported_platforms: SupportedPlatforms::DESKTOP,
            sync_to_cloud: SyncToCloud::Never,
            private: false,
            toml_path: "terminal.input.autosuggestions.local_ai_enabled",
            description: "Whether local AI command autocomplete autosuggestions are enabled.",
        },
