...
use super::{
    ...
    pane_search_text_fragments, preferred_agent_tab_titles, resolve_compact_subtitle,
    search_fragments_contain_query, select_summary_pane_kind_icons,
    should_keep_detail_sidecar_visible_for_mouse_position, subtitle_options_for_primary,
