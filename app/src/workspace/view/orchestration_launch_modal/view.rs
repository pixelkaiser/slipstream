...
const FEATURE_ITEMS: &[FeatureItem] = &[
    ...
    FeatureItem {
        ...
        description: "Agents will now orchestrate swarms of subagents, allowing you to parallelize tasks.",
        badge: None,
    },
    FeatureItem {
        icon: Icon::Cognition,
...
impl OrchestrationLaunchModal {
    ...
    fn render_description(appearance: &Appearance) -> Box<dyn Element> {
        Text::new(
            "We've made major improvements to cloud agent orchestration.",
            appearance.ui_font_family(),
            14.,
        )
