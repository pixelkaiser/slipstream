        ...
        match save_status {
            AIDocumentSaveStatus::NotSaved => {
                ...
                let tooltip = ui_builder
                    .tool_tip("Save and auto-sync this plan to Drive".to_string())
                    .build()
                    .finish();
            ...
            AIDocumentSaveStatus::Saved => {
                ...
                let ui_builder = appearance.ui_builder().clone();
                let tooltip_text =
                    "This plan is synced to Drive and will auto save any edits you make."
                        .to_string();
...
impl BackingView for AIDocumentView {
    ...
    fn pane_header_overflow_menu_items(
            ...
            AIDocumentModel::as_ref(ctx).get_document_warp_drive_object_link(&self.document_id, ctx)
        {
            ...
            menu_items.push(
                MenuItemFields::new("Show in Drive")
