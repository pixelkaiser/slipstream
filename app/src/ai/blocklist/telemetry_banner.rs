...
const TITLE_NEW_USERS: &str = "Help improve the app.";
const DESCRIPTION: &str = "We may collect certain console interactions to improve AI capabilities. You can opt out any time.";
