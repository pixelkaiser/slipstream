        ...
        if !self.prompt_rules.is_empty() {
            ...
            let rules_copy = FormattedText::new([
                FormattedTextLine::Line(vec![FormattedTextFragment::plain_text(
                    "Rules are custom prompts that describe when to use a specific model. The app intelligently matches your tasks against these rules.",
                )]),
                FormattedTextLine::Line(vec![FormattedTextFragment::plain_text(
        ...
        let routing_type_copy = FormattedText::new([
            FormattedTextLine::Line(vec![
                ...
                FormattedTextFragment::plain_text(
                    " routing chooses a model based on the app's classification of the task's difficulty.",
                ),
            ]),
            FormattedTextLine::Line(vec![
