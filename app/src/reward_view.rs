...
const SUBTITLE_SENT_REFERRAL: &str = "You earned an exclusive theme for referring someone.";
const SUBTITLE_RECEIVED_REFERRAL: &str = "You earned an exclusive theme for being referred.";
