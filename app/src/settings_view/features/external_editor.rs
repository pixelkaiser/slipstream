...
impl ExternalEditorView {
    ...
    fn init_editor_dropdown(
        ...
        let built_in_editor_name = ChannelState::product_name();
        items.push(DropdownItem::new(
            built_in_editor_name,
        ...
        match editor_to_open_files {
            ...
            EditorChoice::Warp => dropdown.set_selected_by_name(built_in_editor_name, ctx),
...
impl View for ExternalEditorView {
    ...
    fn render(&self, app: &warpui::AppContext) -> Box<dyn warpui::Element> {
        ...
        let default_layout = render_dropdown_item(
            appearance,
            "Choose a layout to open files in the built-in editor",
            None,
            None,
            LocalOnlyIconState::for_setting(
        ...
        column.add_child(render_body_item::<ExternalEditorAction>(
            "Open Markdown files in the built-in Markdown viewer by default".to_string(),
            Some(AdditionalInfo {
