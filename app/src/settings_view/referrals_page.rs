...
const HEADER_TEXT: &str = "Invite a friend";
const ANONYMOUS_USER_HEADER_TEXT: &str = "Sign up to participate in the referral program";
...
const REWARD_INTRO: &str = "Get exclusive rewards when you refer someone*";
