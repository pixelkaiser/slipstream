...
static SAFE_MODE_DESCRIPTION: LazyLock<&'static str> = LazyLock::new(|| {
    "When this setting is enabled, the app will scan blocks, the contents of \
        saved objects, and Oz prompts for potential sensitive \
...
const TELEMETRY_TITLE: &str = "Help improve the app";
                ...
                ui_builder
                    .paragraph(
                        if is_checked {
                            ...
                            for product functionality, and the app will not use it for analytics."
                        } else {
            ...
            .with_child(
                ui_builder
                    .paragraph(
                        ...
                        from the app to external servers to ensure you feel comfortable that your \
                ...
                Align::new(
                    appearance
                        ...
                        .link(
                            ...
                            Some(links::privacy_policy_url().into()),
                            None,
                            self.link_mouse_state.clone(),
                        )
                        .soft_wrap(false)
