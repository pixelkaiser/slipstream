...
impl SettingsPageMeta for WarpDriveSettingsPageView {
    ...
    fn should_render(&self, _ctx: &AppContext) -> bool {
        FeatureFlag::OpenWarpNewSettingsModes.is_enabled() && !ChannelState::is_slipstream()
    }
...
impl SettingsWidget for WarpDriveHeaderWidget {
    ...
    fn render(
        ...
        let message = Container::new(
            Text::new_inline(
                "To use Drive, please create an account.".to_string(),
    ...
    fn render(
        ...
        render_body_item::<WarpDriveSettingsPageAction>(
            ...
            appearance
                ...
                .finish(),
            Some("Drive is a workspace in your terminal where you can save Workflows, Notebooks, Prompts, and Environment Variables for personal use or to share with a team.".into()),
        )
    }
}
